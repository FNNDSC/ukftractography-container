...
RUN \
    ...
    apt-get update \
    && apt-get install -y libsm6 libxext6 libxt6 libglu1-mesa libxrender-dev
...
ENV PATH=/opt/28257-linux-amd64-UKFTractography-gitbb0b6f2-2020-07-28/lib/Slicer-4.10/cli-modules:/opt/Slicer-4.10.2:/opt/Slicer-4.10.2/bin:$PATH \
